...
function ProductCard(props) {
    ...
    return (
        <div className="card w-64 bg-white rounded-xl border border-gray-200">
            {/* Product Image */}
            <div className="h-80 overflow-hidden relative rounded-xl">
    {/* Product Image */}
    <img
        src={props.img} // Replace with your image URL
        alt="Product"
    ...
    <div className="absolute bottom-3 left-3 bg-white px-2 py-1 rounded-2xl flex items-center gap-1 shadow-md">
        ...
        <span className="text-xs text-gray-400">(6.3K)</span>
            ...
            <div className="p-3">
                ...
                {/* Product Name */}
                <h2 className="card-title text-sm font-medium mt-2">
                    Aramya
                </h2>
