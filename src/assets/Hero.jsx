...
function Hero() {
  return (
    <div className="mt-28">
      <div>
        <div className="bg-[rgb(224,208,228)] flex items-center justify-center p-1 m-4 text-[rgb(95,15,42)] rounded-xl">
          <span className="mr-2">1,00,000+</span>{' '}
          <span className="bg-[rgb(95,15,42)] rounded-2xl text-xs text-white pl-2 pr-2">
            HAPPY CUSTOMERS
          </span>
        </div>
        <Swiper
